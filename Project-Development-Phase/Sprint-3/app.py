...
class Video(object):
	def __init__(self):
		...
		self.model = load_model(r"C:\Users\Venomhere\Desktop\Final_Project\Flask\asl_model.h5") 
	...
	def get_frame(self):
		...
		self.y = pred[0]
		cv2.putText(frame,'The Alphabet is: '+str(self.index[self.y]),(170,50),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,0),3)
